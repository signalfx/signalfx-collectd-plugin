...
def main():
    ...
    parser.add_argument('--update', default=None, help='If set, will look for a collectd file and auto update to the auth token you select.')
    ...
    if len (all_auth_tokens) > 1:
        sys.stderr.write("Multiple auth tokens associated with this account.  Add an --org tag for the auth token you want to update to.\n")
